...
XMLRequest;
		...
		/*Mage::log($xmlResponse, null, 'logfile.log');
		$xml = simplexml_load_string($xmlResponse);

		if($xml->RatedShipment->TransportationCharges->MonetaryValue[0]<=10)
		{
			$xml->RatedShipment->TransportationCharges->MonetaryValue[0]=10;
			$xml->RatedShipment->TotalCharges->MonetaryValue[0]=10;
			$xml->RatedShipment->RatedPackage->TransportationCharges->MonetaryValue[0]=10;
			$xml->RatedShipment->RatedPackage->TotalCharges->MonetaryValue[0]=10;
			//Mage::log($xml->RatedShipment, null, 'logfile.log');
		}	*/
